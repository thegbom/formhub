...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        <div id="app">
            <!--inputbox formid="1" placeholder="2" label="3" startvalue="4"></inputbox-->
            <!--selectbox formid="1" options='[{"text":"test1", "value":"1"},{"text":"test2", "value":"2"}]' label="select" startvalue="1"></selectbox-->
            <!--formhub geturl="api/formlines" posturl="api/formlines"></formhub-->
